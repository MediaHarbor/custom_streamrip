...
APP_DIR = click.get_app_dir("custom_streamrip")
...
class TidalConfig:
    ...
    # time. If you haven't used custom_streamrip in more than a week, you may have to log
...
@dataclass(slots=True)
class DeezerConfig:
    # An authentication cookie that allows custom_streamrip to use your Deezer account
    # See https://github.com/nathom/custom_streamrip/wiki/Finding-Your-Deezer-ARL-Cookie
...
class MetadataConfig:
    ...
    # See https://github.com/nathom/custom_streamrip/wiki/Metadata-Tag-Names for more info
    exclude: list[str]
...
HOME = Path.home()
DEFAULT_DOWNLOADS_FOLDER = os.path.join(HOME, "custom_streamripDownloads")
